...
<link href="${pageContext.request.contextPath}/lib/css/app/index.css" rel="stylesheet" type="text/css" />
				...
				<c:if test="${fn:contains(user_session.dept.permissions,2) }">
					<div class="float-over-bottom">
						<a class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent"
							href="${pageContext.request.contextPath }/v1/new_issue"> 
...
<script type="text/javascript" src="${pageContext.request.contextPath}/lib/js/app/v1/index.js"></script>
