...
<link href="${pageContext.request.contextPath}/lib/css/app/per_manage.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${pageContext.request.contextPath}/lib/js/app/v1/permission_management.js"></script>
