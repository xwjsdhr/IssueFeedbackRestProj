      		...
      		<div class="row"> 
      			<div class="col-lg-12">
      				<div class="form-group">
	      				...
	      				<input type="text" id="inputIssueTitle" class="form-control" placeholder="请输入标题" required/>
      				</div>
      			</div>
      		</div>
      		<div class="row">
      			<div class="col-lg-12">
	      			<div class="form-group">
	      				...
	      				<select id="inputIssueProject" class="form-control" placeholder="请输入标题" required></select>
	      			</div>
      			</div>
      		</div>
      		<div class="row">
      			<div class="col-lg-12">
      				<div class="form-group">
	      				...
	      				<textarea rows="4" cols="1" id="inputIssueContent" class="form-control" placeholder="请输入内容" required></textarea> 
      				</div>
      			</div>
      		</div>
      	</div>
